...
function generatePost(postData) {
    ...
    postControlsElement.classList.add('post_mobile_controls_collapse', 'dropdown');
    ...
    if (postData.media) {
        ...
        viewSameAnchor.href = 'https://desuarchive.org/' + postData.board.shortname + '/search/image/' + postData.media?.safe_media_hash;
        ...
        googleAnchor.href = 'https://www.google.com/searchbyimage?image_url=' + postData.media.thumb_link;
    ...
    timestampAnchor.setAttribute('datetime', new Date(postData.timestamp * 1000).toISOString());
    timestampAnchor.dataset.originalTitle = postData.fourchan_date;
    timestampAnchor.textContent = new Date(postData.timestamp * 1000).toLocaleString();
    ...
    postIdElement.href = 'https://desuarchive.org/' + postData.board.shortname + '/thread/' + postData.thread_num + '/#' + postData.num;
    ...
    quoteLink.href = 'https://desuarchive.org/' + postData.board.shortname + '/thread/' + postData.thread_num + '/#q' + postData.num;
    ...
    backlinkListElement.innerHTML = 'Quoted By: <span class="post_backlink" data-post="' + postData.num + '" id="p_b' + postData.num + '"></span><button class="OP-button" style="height: 0px; border-radius: 50%; color: white; background: rgb(34, 0, 68);">OP</button>';
